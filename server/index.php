...
$app->post('/checkout_sessions', function(Request $request, Response $response) use ($app)  {
  ...
  $products = [
    'cause-a' => 'prod_Mgqsoosg3gSjkB',
    'cause-b' => 'prod_MgqtR0IHKSuRen',
  ];

  $session = \Stripe\Checkout\Session::create([
    'success_url' => 'http://localhost/gloriousVision/?success=true',
    'cancel_url' => 'http://localhost/gloriousVision/?cancel=true',
    'mode' => 'payment',
    // 'customer' => 'cus_MgpymMdj4sOLmG',
